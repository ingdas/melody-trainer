...
const PianoView = ({ scaleRange, anyTonic, currentScale, currentDisplayScale, notes, context, trebleInstrument }) => {
        ...
        {pianoWhiteKeys.map((note, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              onPress={() => {console.log(note,'was pressed'), playSound(note,trebleInstrument,context) }}
            >
